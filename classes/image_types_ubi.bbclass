...
IMAGE_CMD_ubi_prepend = " \
	...
	cp ${DEPLOY_DIR_IMAGE}/kernel.uImage ${IMAGE_ROOTFS}/boot/; \
	cp ${DEPLOY_DIR_IMAGE}/${UBOOT_IMAGE} ${IMAGE_ROOTFS}/boot/u-boot.bin; \
	cp ${DEPLOY_DIR_IMAGE}/update_ruby/uldr.bin ${IMAGE_ROOTFS}/boot/; \
	cp ${DEPLOY_DIR_IMAGE}/update_ruby/checkusb.img ${IMAGE_ROOTFS}/boot/; \
	cp ${DEPLOY_DIR_IMAGE}/update_ruby/ramdisk_update_script.sh ${IMAGE_ROOTFS}/boot/; \
"
